...
Version: 3.0
Description: Этот плагин позволяет использовать медиа-файл заголовка для отображения на ваших страницах блога.
Author: Dan Cannon
...
function dhnd_menu() {
  add_menu_page('Dynamic Header', 'Dynamic Header', 8, __FILE__, 'dhnd_main_menu', '/wp-content/plugins/dynamic-headers/images/custom_header_icon.png');
  add_submenu_page(__FILE__, 'Инструкция', 'Инструкция', 8, __FILE__, 'dhnd_main_menu');
  add_submenu_page(__FILE__, 'Загрузить новый файл', 'Загрузить новый файл', 8, 'dhnd_add_menu', 'dhnd_add_menu');
  add_submenu_page(__FILE__, 'Управление файлами', 'Управление файлами', 8, 'dhnd_manage_files', 'dhnd_manage_files');
  add_submenu_page(__FILE__, 'Свойства', 'Свойства', 8, 'dhnd_options', 'dhnd_options');
  add_submenu_page(__FILE__, 'Об авторе', 'Об авторе', 8, 'dhnd_about', 'dhnd_about');
}
