...
if( ! function_exists( 'cntctfrm_settings' ) ) {
	function cntctfrm_settings() {
		...
		$cntctfrm_option_defaults = array(
			...
			'cntctfrm_required_subject_field' => 0,
            ...
            'cntctfrm_reset_label' => array( 'en' => __( "Reset", 'contact_form' ) ),
		...
		if( empty( $cntctfrm_options['cntctfrm_language'] ) && ! is_array( $cntctfrm_options['cntctfrm_name_label'] ) ) {
            ...
            $cntctfrm_options['cntctfrm_reset_label']			= array( 'en' => $cntctfrm_option_defaults['cntctfrm_reset_label']['en'] );
		...
		if( isset( $_POST['cntctfrm_form_submit'] ) && check_admin_referer( plugin_basename(__FILE__), 'cntctfrm_nonce_name' ) ) {
			...
			if($cntctfrm_options_submit['cntctfrm_additions_options'] == 0) {
				...
				if( empty( $cntctfrm_options['cntctfrm_language'] ) ) {
                    ...
                    $cntctfrm_options_submit['cntctfrm_reset_label']				= $cntctfrm_option_defaults['cntctfrm_reset_label'];
                    ...
                    $cntctfrm_options_submit['cntctfrm_reset_label']['en']				= $cntctfrm_option_defaults['cntctfrm_reset_label']['en'];
			 ...
			 $cntctfrm_options_submit['cntctfrm_redirect_url']				= '';
				...
				if( $cntctfrm_options_submit['cntctfrm_change_label'] == 1 ) {
					foreach( $_POST['cntctfrm_name_label'] as $key=>$val ){
                        ...
                        $cntctfrm_options_submit['cntctfrm_reset_label'][$key]				= $_POST['cntctfrm_reset_label'][$key];
				...
				<tr valign="top" class="cntctfrm_additions_block <?php if($cntctfrm_options['cntctfrm_additions_options'] == '0') echo "cntctfrm_hidden"; ?>">
					...
					<td class="cntctfrm_change_label_block <?php if($cntctfrm_options['cntctfrm_change_label'] == '0') echo "cntctfrm_hidden"; ?>">
						...
						<div class="cntctfrm_language_tab cntctfrm_tab_en">
                            ...
                            <input type="text" name="cntctfrm_reset_label[en]" value="<?php echo $cntctfrm_options['cntctfrm_reset_label']['en']; ?>" /> <span class="cntctfrm_info"><?php _e( "Reset", 'contact_form' ); ?></span><br />
						...
						<?php if( ! empty( $cntctfrm_options['cntctfrm_language'] ) ){
							foreach( $cntctfrm_options['cntctfrm_language'] as $val ) { ?>
								<div class="cntctfrm_language_tab hidden cntctfrm_tab_<?php echo $val; ?>">
                                    ...
                                    <input type="text" name="cntctfrm_reset_label[<?php echo $val; ?>]" value="<?php if( isset( $cntctfrm_options['cntctfrm_reset_label'][$val] ) ) echo $cntctfrm_options['cntctfrm_reset_label'][$val]; ?>" /> <span class="cntctfrm_info"><?php _e( "Reset", 'contact_form' ); ?></span><br />
	...
	function cntctfrm_display_form( $atts = array( 'lang' => 'en' ) ) {
		...
		if( true !== $cntctfrm_result) {
			...
			$content .= '<div style="text-align: left;">
					<input class="text" type="text" size="48" value="'.$name.'" name="cntctfrm_contact_name" id="cntctfrm_contact_name" style="text-align: left; margin: 0;" />
				</div>
			...
			$content .= '<div style="text-align: left;">
					<input class="text" type="text" size="48" value="'.$email.'" name="cntctfrm_contact_email" id="cntctfrm_contact_email" style="text-align: left; margin: 0;" />
				</div>
			';
			if( $cntctfrm_options['cntctfrm_display_phone_field'] == 1 ) {
				...
				$content .= '<div style="text-align: left;">
						<input class="text" type="text" size="48" value="'.$phone.'" name="cntctfrm_contact_phone" id="cntctfrm_contact_phone" style="text-align: left; margin: 0;" />
					</div>
					';
			}
			$content .= '<div style="text-align: left;">
			...
			$content .= '<div style="text-align: left;">
					<textarea rows="10" cols="60" name="cntctfrm_contact_message" id="cntctfrm_contact_message">'.$message.'</textarea>
				</div>';
			...
			$content .= '<div class="buttons" style="text-align: left; padding-top: 8px;">
					...
					<input type="reset" value="'. $cntctfrm_options['cntctfrm_reset_label'][$lang]. '" style="cursor: pointer; margin: 0pt; text-align: center;margin-bottom:10px;" />
...
function cntctfrm_remove_language(){
    ...
    if( isset( $cntctfrm_options['cntctfrm_reset_label'][$_REQUEST['lang']] ) )
        unset( $cntctfrm_options['cntctfrm_reset_label'][$_REQUEST['lang']]);
